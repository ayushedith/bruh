...
export default async function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-transparent border-b border-transparent transition-all duration-300 data-[scrolled=true]:bg-white/80 data-[scrolled=true]:dark:bg-neutral-900/70 data-[scrolled=true]:backdrop-blur data-[scrolled=true]:border-white/10 data-[scrolled=true]:shadow-sm">
